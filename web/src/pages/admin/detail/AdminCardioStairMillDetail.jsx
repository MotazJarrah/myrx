...
const STAIRMILL_ZONE_CONFIG = Object.freeze({
  vo2: {
    label:       'VO2 MAX',
    whyText:
      'Short, max-effort climbs at the ceiling of your aerobic capacity. The stimulus is central — your heart and muscles both adapt to take in and use more oxygen, lifting the engine every easier zone runs on. Use it sparingly: one session a week, full recovery between efforts.',
  ...
  threshold: {
    label:       'THRESHOLD',
    whyText:
      'Sustained hard climbing at the edge of what you can hold. This trains lactate clearance — your body learns to process the burn faster, so the pace you can sustain keeps climbing with it. One or two sessions a week, max.',
  ...
  aerobic: {
    label:       'ENDURANCE',
    whyText:
      'Continuous, conversational climbing. This is your aerobic base — it builds the mitochondrial density and capillary networks that support every harder zone above. Stay steady and resist the urge to push.',
