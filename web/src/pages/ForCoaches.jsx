...
const FAQ_ITEMS = [
  ...
  { q: 'How do I move my current clients over from another platform?',
    a: "From your coach account, send each client a personal invite link by email or SMS — they accept, sign up, and they're on your roster. No spreadsheet imports, no manual data entry." },
  { q: 'What if I get stuck or need help?',
    a: 'Email support is included on every plan — and it\'s identical across tiers, since the only thing that changes between tiers is your client cap. A real person reads and answers every message, usually within a day.' },
