...
TASKS = [
    ...
    ("T089", "Swipe-acceptance rule (per-element) across variant pages", "Design system", "Mobile (+Web later)", "In progress",
     ...
     "Mobile shipped + tsc clean. Web coach mirrors NOT yet aligned (lighter swipe impl) -- separate pass if wanted. Verify on device: swipe BW chart -> tier changes + hero follows; swipe Weighted hero -> zone changes; BW log + Weighted/Carry/AirBike/Ruck charts+logs do NOT swipe.",
